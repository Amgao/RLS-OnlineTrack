...
class GradientDescentL2RLS:
    """Gradient descent with momentum for L2 problems using RLS."""

    def __init__(self, problem: L2Problem, variable: TensorList, n_channel: int, kernel_size: int, step_length: float, momentum: float = 0.0, debug = False, plotting = False, visdom=None):
